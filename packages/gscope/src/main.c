...
#define G_OPTION_FLAG_NONE 0
    ...
    else
    {
        ...
        build_progress = lookup_widget(GTK_WIDGET(gscope_splash), "splash_progressbar");  // build progress meter
        ...
        DISPLAY_init();   /* init the display module [set up the tree view widget] */
