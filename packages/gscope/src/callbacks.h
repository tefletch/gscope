...
void on_find_c_identifier_button1_clicked(GtkButton *button, gpointer user_data);
...
void on_find_files_including_button_enter(GtkButton *button, gpointer user_data);
