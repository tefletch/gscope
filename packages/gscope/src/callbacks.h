...
void on_reset_query_activate(GtkMenuItem *menuitem, gpointer user_data);
#endif


// Gtk-variant menu-item callbacks
//================================
#ifndef GTK4_BUILD   // pre-GTK4 menu-item callbacks
// "command" sub-menu
...
gboolean on_open_file_chooser_dialog_delete_event        (GtkWidget *widget, GdkEvent *event, gpointer user_data);
gboolean on_output_file_chooser_dialog_delete_event      (GtkWidget *widget, GdkEvent *event, gpointer user_data);
...
void on_open_in_terminal_activate             (GSimpleAction *action, GVariant *parameter, gpointer user_data); 
void on_open_in_file_manager_activate         (GSimpleAction *action, GVariant *parameter, gpointer user_data); 
...
// stats dialog is rebuilt every time the window is activated (no close-request hiding)
// TBD: on_save_results_file_chooser_dialog_close_request  MAYBE
gboolean on_aboutdialog1_close_request       (GtkWidget *widget, GdkEvent *event, gpointer user_data);
// TBD: open_file_chooser_dialog
// TBD: output_file_chooser_dialog
#endif
...
// Search Callbacks
//=================================
void on_find_c_identifier_button_clicked       (GtkButton *button, gpointer user_data);
void on_find_definition_of_button_clicked      (GtkButton *button, gpointer user_data);
void on_find_functions_called_by_button_clicked(GtkButton *button, gpointer user_data);
void on_find_functions_calling_button_clicked  (GtkButton *button, gpointer user_data);
void on_find_text_string_button_clicked        (GtkButton *button, gpointer user_data);
void on_find_egrep_pattern_button_clicked      (GtkButton *button, gpointer user_data);
void on_find_files_button_clicked              (GtkButton *button, gpointer user_data);
void on_find_files_including_button_clicked    (GtkButton *button, gpointer user_data);
void on_cancel_button_clicked                  (GtkButton *button, gpointer user_data);
void on_prefs_help_cross_button_clicked        (GtkButton *button, gpointer user_data);
void on_prefs_help_source_button_clicked       (GtkButton *button, gpointer user_data);
void on_prefs_help_file_button_clicked         (GtkButton *button, gpointer user_data);
void on_prefs_help_general_button_clicked      (GtkButton *button, gpointer user_data);
void on_prefs_help_search_button_clicked       (GtkButton *button, gpointer user_data);
...
void on_no_rebuild_radiobutton_toggled   (GtkToggleButton *togglebutton, gpointer user_data);
void on_rebuild_radiobutton_toggled      (GtkToggleButton *togglebutton, gpointer user_data);

void on_force_rebuild_radiobutton_activate(GtkButton *button, gpointer user_data);
void on_no_rebuild_radiobutton_activate   (GtkButton *button, gpointer user_data);
void on_rebuild_radiobutton_activate      (GtkButton *button, gpointer user_data);
...
void on_initial_context_browse_button_clicked  (GtkButton *button, gpointer user_data);
void on_cross_reference_browse_button_clicked  (GtkButton *button, gpointer user_data);
void on_search_log_browse_button_clicked       (GtkButton *button, gpointer user_data);
void on_file_name_browse_button_clicked        (GtkButton *button, gpointer user_data);
void on_search_log_button_clicked              (GtkButton *button, gpointer user_data);
void on_stats_dialog_closebutton_clicked       (GtkButton *button, gpointer user_data);
void on_session_info_button_clicked            (GtkButton *button, gpointer user_data);


gboolean on_gscope_preferences_destroy_event(GtkWidget *widget, GdkEvent *event, gpointer user_data);


void on_output_file_chooser_dialog_response(GtkDialog *dialog, gint response_id, gpointer user_data);
void on_open_file_chooser_dialog_response  (GtkDialog *dialog, gint response_id, gpointer user_data);
void on_folder_chooser_dialog_response     (GtkDialog *dialog, gint response_id, gpointer user_data);
...
void on_search_log_entry_changed          (GtkEditable *editable, gpointer user_data);
void on_typeless_entry_changed            (GtkEditable *editable, gpointer user_data);
void on_ignored_entry_changed             (GtkEditable *editable, gpointer user_data);
...
void on_source_entry_changed              (GtkEditable *editable, gpointer user_data);
void on_cref_entry_changed                (GtkEditable *editable, gpointer user_data);
void on_name_entry_changed                (GtkEditable *editable, gpointer user_data);
...
gboolean on_treeview1_popup_menu(GtkWidget *widget, gpointer user_data);
