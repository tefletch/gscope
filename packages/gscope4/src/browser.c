...
static void         on_left_expander_button_release_event(GtkGesture *gesture, int n_press, double x, double y, gpointer *user_data);
//static gboolean     on_right_expander_button_release_event(GtkWidget *widget, GdkEventButton *event, gpointer user_data);
static void         on_right_expander_button_release_event(GtkGesture *gesture, int n_press, double x, double y, gpointer *user_data);
//static gboolean     on_left_collapser_button_release_event(GtkWidget *widget, GdkEventButton *event, gpointer user_data);
static void         on_left_collapser_button_release_event(GtkGesture *gesture, int n_press, double x, double y, gpointer *user_data);
//static gboolean     on_right_collapser_button_release_event(GtkWidget *widget, GdkEventButton *event, gpointer user_data);
static void         on_right_collapser_button_release_event(GtkGesture *gesture, int n_press, double x, double y, gpointer *user_data);
...
//********************************************************************************************** 
static gboolean on_left_expander_button_release_event(GtkGesture *gesture, int n_press, double x, double y, gpointer *user_data)
{
    tcb_t   *tcb = user_data;
    guint   row, col;
    ...
    // Revisit: gtk_widget_destroy(widget);
...
//********************************************************************************************** 
static gboolean on_right_expander_button_release_event(GtkGesture *gesture, int n_press, double x, double y, gpointer *user_data)
{
    tcb_t   *tcb = user_data;
    guint   row, col;
...
//********************************************************************************************** 
static gboolean on_left_collapser_button_release_event(GtkGesture *gesture, int n_press, double x, double y, gpointer *user_data)
{
    tcb_t   *tcb = user_data;
    guint   row, col;
...
//********************************************************************************************** 
static gboolean on_right_collapser_button_release_event(GtkGesture *gesture, int n_press, double x, double y, gpointer *user_data)
{
    tcb_t   *tcb = user_data;
    guint   row, col;
...
static void make_expander_at_position(tcb_t *tcb, guint col, guint row, dir_e direction)
{
    ...
    {
        g_signal_connect((gpointer)expander, "released",
